    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            //for some reason, loop only runs the if statement once, after that, it will not change the other values to what they are supposed to be, I'm unsure what I am doing wrong here when running this loop
            while (linkedListNode != null)
            {
                if((string)linkedListNode.Value == "sad")
                {
                    linkedList.AddBefore(linkedListNode, "happy");
                    linkedList.Remove(linkedListNode.Value);
                }
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.Remove(linkedListNode1);
            anagram.AddLast(linkedListNode1.Value);
