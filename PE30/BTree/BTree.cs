...
namespace BTree
{
    public partial class BTreeForm : Form
    {
        ...
        private void Exercise1__Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                node = new BTree(random.Next(50) + 1, root);
        ...
        private void Exercise6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            person = new Person("Spencer", 22);
            node = new BTree(person, root);
            root = node;
            person = new Person("Jordan", 27);
            node = new BTree(person, root);
            person = new Person("Brian", 60);
            node = new BTree(person, root);
            person = new Person("Deena", 56);
            node = new BTree(person, root);
            person = new Person("Marvin", 85);
            node = new BTree(person, root);
            person = new Person("Jane", 79);
            node = new BTree(person, root);
            person = new Person("Holly", 63);
            node = new BTree(person, root);
            person = new Person("Stewart", 39);
            node = new BTree(person, root);
            person = new Person("Ahren", 35);
            node = new BTree(person, root);
            person = new Person("Chase", 9);
            node = new BTree(person, root);
            person = new Person("Brooke", 7);
            node = new BTree(person, root);
            person = new Person("Conner", 7);
            node = new BTree(person, root);
            person = new Person("Christa", 40);
            node = new BTree(person, root);
            person = new Person("Dingo", 7);
            node = new BTree(person, root);
            person = new Person("Sky", 2);
            node = new BTree(person, root);
